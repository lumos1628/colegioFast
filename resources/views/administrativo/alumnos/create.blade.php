<x-administrativo-layout>
    <div class="max-w-2xl mx-auto">
        ...
        <h1 class="text-2xl font-bold text-gray-900 mb-6">Nuevo Alumno</h1>
        ...
        <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
            <form action="{{ route('admin.alumnos.store') }}" method="POST">
                ...
                <div class="space-y-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                        ...
                        <div>
                            ...
                            <input type="text" name="seccion" value="{{ old('seccion', 'A') }}" maxlength="1" required
                    ...
                    <div>
                        ...
                        <input type="email" name="email" value="{{ old('email') }}"
                               class="block w-full rounded-lg border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 text-sm @error('email') border-red-300 @enderror">
                ...
                <div class="flex items-center justify-end gap-3 mt-6 pt-6 border-t border-gray-200">
                    ...
                    <button type="submit" class="px-4 py-2 text-sm font-medium text-white bg-blue-600 rounded-lg hover:bg-blue-700">Crear alumno</button>
                </div>
            </form>
        </div>
    </div>
